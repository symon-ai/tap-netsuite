...
import json
import singer
from .transaction_entities import Customers, CustomerPayments, PurchaseOrder, Invoice, JournalEntries, InventoryTransfer, InventoryAdjustment, InventoryItem, VendorBills, VendorPayments, SalesOrders, CreditMemos, Items
...
class ExtendedNetSuiteConnection:
    def __init__(self, account, consumer_key, consumer_secret, token_key, token_secret, caching=True, page_size=100):
        ...
        ns_client = ExtendedNetSuiteClient(
            account=account, caching=caching, page_size=page_size)
